    ...
    <div class="row">
        ...
        <div class="col-9">
            <form action="" method="post" class="forms-yo">
                ...
                <div style="padding: 3% 10% 0px 15%;">
                    <div class="row">
                        <span class="text-yo-title" style="margin-bottom: 30px; font-size: 24px;">Siempre es bueno conocer propietarios amorosos y responsables</span>

                        <div class="col">
                            <span style="text-align: left;">Mi nombe es <input type="text" class="form-text" name="nombre" value=" <?php echo  $nombre = isset($nombre) ? $nombre : ' ' ?>" required> ,vivo en la ciudad de <input type="text" class="form-text" name="ciudad" value="<?php echo  $nombre = isset($ciudad) ? $ciudad : ' ' ?>" required></span>

                            <span style="margin-top: 35px;">
                                Pueden contactarme para ampliar la información de mi mascota, <input type="text" class="form-text" name="phone" value=" <?php echo  $nombre = isset($phone) ? $phone : ' ' ?>">
                            </span>

                            <span>
                                al correo eletrónico <input type="text" class="form-text" name="email" value=" <?php echo  $nombre = isset($email) ? $email : ' ' ?>" required> o también al teléfono <input type="text" class="form-text" name="celular" value="<?php echo  $celular = isset($celular) ? $celular : ' ' ?>" required>
                            </span>
                        </div>
                    </div>
                    <div class="row">
