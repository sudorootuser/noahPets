    ...
    <div class="row">
        ...
        <div class="col-9">
            ...
            <?php } else { ?>
                ...
                <div class="row">
                    <div class="col food-balance">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    <label class="form-check-label" for="Pollo_Res">
                                        Dieta Natural Balanceada Gatos - Pollo y Res
                                    </label>
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Pollo_Res" id="Pollo_Res" name="ideal_check" <?php echo $ideal_check == 'Pollo_Res' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    <label class="form-check-label" for="Pescado">
                                        Dieta Natural Balanceada Gatos - Pescado
                                    </label>
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Pescado" id="Pescado" name="ideal_check" <?php echo $ideal_check == 'Pescado' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col food-balance">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    <label class="form-check-label" for="Cuidado Digestivo">
                                        Dieta Natural Prescrita Gatos - Cuidado Digestivo
                                    </label>
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Cuidado Digestivo" id="Cuidado Digestivo" name="ideal_check" <?php echo $ideal_check == 'Cuidado Digestivo' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Segunda parte -->
                <div class="row">
                    <div class="col-6 food-balance">
                        <div class="card">
                            <img src="<?php echo SERVERURL ?>view/assets/img/Balance_res.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <div class="form-check-fd">
                                    <label class="form-check-label" for="Peso-Diabetes">
                                        Dieta Natural Prescrita Gatos - Control de Peso-Diabetes
                                    </label>
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Peso-Diabetes" id="Peso-Diabetes" name="ideal_check" <?php echo $ideal_check == 'Peso-Diabetes' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 food-balance">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    <label class="form-check-label" for="Renal Pollo">
                                        Dieta Natural Prescrita Gatos - Cuidado Renal Pollo
                                    </label>
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Renal Pollo" id="Renal Pollo" name="ideal_check" <?php echo $ideal_check == 'Renal Pollo' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    <label class="form-check-label" for="Cuidado_Digestivo">
                                        Dieta Natural Prescrita - Senior
                                    </label>
                                    <br>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    ...
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Pollo_Res" id="Pollo_Res" name="cuidado_check" <?php echo $cuidado_check == 'Pollo_Res' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    ...
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Pescado" id="Pescado" name="cuidado_check" <?php echo $cuidado_check == 'Pescado' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    ...
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Cuidado Digestivo" id="Cuidado Digestivo" name="cuidado_check" <?php echo $cuidado_check == 'Cuidado Digestivo' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    ...
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Peso-Diabetes" id="Peso-Diabetes" name="cuidado_check" <?php echo $cuidado_check == 'Peso-Diabetes' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-check-fd">
                                    ...
                                    <br>
                                    <input class="form-check-input check-food check-custom-food" type="radio" value="Renal Pollo" id="Renal Pollo" name="cuidado_check" <?php echo $cuidado_check == 'Renal Pollo' ? 'checked' : '' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
