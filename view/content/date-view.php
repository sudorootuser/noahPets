    ...
    <div class="row">
        ...
        <div class="col">
            <form action="" method="post" class="forms-date">
                <span>Zoe nacio el</span>
                <div class="row">
                    <input class="form-select-date" type="date" name="" id="">
                    <br>
                ...
                <div class="row">
                    <div class="col">
                        <div class="button-home-yo">
                            <a href="<?php echo SERVERURL; ?>weight/">Continuar <img class='mi-yo-img' ; src="<?php echo SERVERURL; ?>view/assets/img/icons-pets.png"> </a>
                        </div>
                    </div>
                </div>
                </span>
